Shader "SR/AMP/Slime/Body/Glitter MatCap Galaxy" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.z = rsqrt(tmp0.z);
                tmp2.xyz = tmp1.xyz * tmp0.zzz + float3(0.0, 1.0, 0.0);
                ...
                tmp5.z = tmp0.w * tmp3.z;
                tmp5.xy = tmp2.xy * float2(-1.0, -1.0) + tmp3.xy;
                ...
                tmp2.yzw = tmp2.yzw - tmp5.xyz;
                tmp2.yzw = tmp0.xxx * tmp2.yzw + tmp5.xyz;
                ...
                tmp2.yzw = tmp2.yzw - tmp5.xyz;
                tmp2.xyz = tmp2.xxx * tmp2.yzw + tmp5.xyz;
                tmp5.xyz = tmp1.www * float3(0.625, 0.625, 0.625) + tmp2.xyz;
                tmp5.xyz = -tmp3.xyz * tmp2.xyz + tmp5.xyz;
                tmp2.xyz = tmp2.xyz * tmp3.xyz;
                tmp2.xyz = tmp5.xyz * float3(0.8, 0.8, 0.8) + tmp2.xyz;
                tmp2.xyz = float3(1.0, 1.0, 1.0) - tmp2.xyz;
                tmp0.xyz = saturate(-tmp2.xyz * tmp0.yzw + float3(1.0, 1.0, 1.0));
                tmp0.w = dot(tmp1.xyz, tmp1.xyz);
                tmp0.w = rsqrt(tmp0.w);
                tmp1.xyz = tmp0.www * tmp1.xyz;
                tmp2.xyz = tmp4.yyy * unity_WorldToObject._m01_m11_m21;
                tmp2.xyz = unity_WorldToObject._m00_m10_m20 * tmp4.xxx + tmp2.xyz;
                tmp2.xyz = unity_WorldToObject._m02_m12_m22 * tmp4.zzz + tmp2.xyz;
