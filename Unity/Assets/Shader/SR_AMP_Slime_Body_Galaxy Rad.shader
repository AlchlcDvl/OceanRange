Shader "SR/AMP/Slime/Body/Galaxy Rad" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.xw = tmp0.xw * float2(4.0, 5.688889);
                tmp0.w = floor(tmp0.w);
                tmp0.z = tmp0.w * 0.1757812 + tmp0.z;
