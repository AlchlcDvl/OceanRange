Shader "SR/AMP/Slime/Body/MultiColor BoomCracks" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.w = tmp1.x * -1.5 + 1.5;
                tmp1.x = saturate(tmp0.x * 2.0 + -1.0);
                ...
                tmp2.xyz = tmp2.xyz - tmp4.xyz;
                tmp2.xyz = tmp1.xxx * tmp2.xyz + tmp4.xyz;
                ...
                tmp5.xyz = tmp5.xyz - tmp6.xyz;
                tmp5.xyz = tmp1.xxx * tmp5.xyz + tmp6.xyz;
                tmp4.xyz = tmp4.xyz - tmp5.xyz;
                tmp1.zw = inp.texcoord.zw - inp.texcoord.xy;
                tmp1.zw = _ColorMaskUV1.xx * tmp1.zw + inp.texcoord.xy;
                tmp6 = tex2D(_ColorMask, tmp1.zw);
                ...
                tmp4.xyz = tmp4.xyz - tmp5.xyz;
                tmp1.xzw = tmp1.xxx * tmp4.xyz + tmp5.xyz;
                tmp1.xzw = tmp1.xzw - tmp2.xyz;
                tmp1.xzw = tmp6.zzz * tmp1.xzw + tmp2.xyz;
                tmp0.x = tmp6.x * _GlossPowerRGB.x;
                tmp2.x = -tmp6.x * _GlossPowerRGB.x + _GlossPowerRGB.y;
                tmp0.x = tmp6.y * tmp2.x + tmp0.x;
                tmp2.x = _GlossPowerRGB.z - tmp0.x;
                tmp0.x = tmp6.z * tmp2.x + tmp0.x;
                tmp0.x = tmp0.x * 16.0 + -1.0;
                tmp0.x = exp(tmp0.x);
                tmp0.x = tmp0.y * tmp0.x;
                tmp0.x = exp(tmp0.x);
                tmp0.y = tmp0.x * tmp0.x;
                tmp2.x = tmp6.x * _GlossRGB.x;
                tmp2.y = -tmp6.x * _GlossRGB.x + _GlossRGB.y;
                tmp2.x = tmp6.y * tmp2.y + tmp2.x;
                tmp2.y = _GlossRGB.z - tmp2.x;
                tmp2.x = tmp6.z * tmp2.y + tmp2.x;
                ...
                tmp0.xyz = tmp1.xzw + tmp0.xxx;
                tmp0.xyz = -tmp3.xyz * tmp1.xzw + tmp0.xyz;
                tmp1.xzw = tmp1.xzw * tmp3.xyz;
                tmp0.xyz = tmp0.xyz * float3(0.8, 0.8, 0.8) + tmp1.xzw;
                tmp1.x = dot(tmp0.xyz, float3(0.299, 0.587, 0.114));
                tmp1.xzw = tmp1.xxx - tmp0.xyz;
                tmp1.xzw = tmp1.xzw * float3(0.5, 0.5, 0.5) + tmp0.xyz;
                ...
                tmp1.xzw = tmp1.xzw * float3(0.75, 0.75, 0.75) + -tmp0.xyz;
                tmp2.xyw = _Char.xxx * tmp1.zwx + tmp0.yzx;
                ...
                tmp0.x = tmp0.y * tmp0.x;
                tmp0.xyz = tmp0.xxx * tmp1.xzw + float3(1.0, 1.0, 1.0);
                tmp1.x = tmp0.w * 40.0;
                tmp1.zw = tmp0.ww * float2(10.0, 10.0) + float2(-0.8, -0.333);
                ...
                tmp1.w = tmp1.y * _CrackAmount;
                tmp3.yzw = tmp1.www * tmp3.yzw + tmp5.xyz;
                tmp3.yzw = _CrackAmount.xxx * tmp1.yyy + tmp3.yzw;
                tmp3.yzw = saturate(tmp3.yzw - float3(1.0, 1.0, 1.0));
                tmp1.yzw = tmp6.xyz * tmp1.zzz + tmp3.yzw;
                ...
                tmp0.xyw = tmp0.www * tmp0.yzx + tmp1.yzx;
