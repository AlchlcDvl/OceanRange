Shader "SR/AMP/Slime/Body/Quantum MultiColor" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.x = tmp0.x * tmp4.w + 1.0;
                tmp2.y = -tmp0.w * tmp0.x + tmp2.y;
                tmp0.x = tmp0.x * tmp0.w;
                tmp0.x = _GhostToggle * tmp2.y + tmp0.x;
                ...
                tmp0.x = tmp1.w * 0.5;
                tmp0.w = -tmp1.w * 0.5 + inp.texcoord4.y;
                tmp5.y = -tmp0.w * _ProjectionParams.x + tmp0.x;
                tmp5.x = inp.texcoord4.x;
                tmp5.xy = tmp5.xy / tmp1.ww;
                tmp5.z = tmp5.x * 1.78;
                tmp5 = tmp0.zzzz * float4(10.0, 10.0, 10.0, 10.0) + tmp5.zyzy;
                tmp0.xz = _ScreenParams.yy * float2(0.025, 0.05);
                tmp0.xz = float2(128.0, 128.0) / tmp0.xz;
                tmp6.xy = tmp0.xz - float2(1.0, 1.0);
                tmp7 = float4(1.0, 1.0, 1.0, 1.0) / tmp0.xxzz;
                tmp0.xz = trunc(tmp6.xy);
                tmp6.xy = tmp7.xw * tmp0.xz;
                tmp6.z = 0.0;
                tmp5 = tmp5 * tmp7 + tmp6.zxzy;
                tmp6 = tex2D(_PixelNoise, tmp5.xy);
                tmp5 = tex2D(_PixelNoise, tmp5.zw);
                tmp0.x = max(tmp5.x, tmp6.z);
                tmp0.x = tmp0.x * 4.0;
                ...
                tmp0.w = tmp0.w + 1.0;
                tmp0.xw = tmp0.xw * float2(0.25, 0.5);
                tmp0.w = log(tmp0.w);
                ...
                tmp1.xyz = _GreenTopColor.www * tmp1.xyz + tmp2.xyz;
                tmp3.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _GreenMiddleColor.xyz;
                tmp3.xyz = _GreenMiddleColor.www * tmp3.xyz + tmp2.xyz;
                tmp1.xyz = tmp1.xyz - tmp3.xyz;
                tmp1.xyz = tmp0.xxx * tmp1.xyz + tmp3.xyz;
                tmp4.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _GreenBottomColor.xyz;
                tmp4.xyz = _GreenBottomColor.www * tmp4.xyz + tmp2.xyz;
                tmp3.xyz = tmp3.xyz - tmp4.xyz;
                tmp3.xyz = tmp0.xxx * tmp3.xyz + tmp4.xyz;
                tmp1.xyz = tmp1.xyz - tmp3.xyz;
                tmp1.xyz = tmp0.yyy * tmp1.xyz + tmp3.xyz;
                tmp3.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _RedTopColor.xyz;
                tmp3.xyz = _RedTopColor.www * tmp3.xyz + tmp2.xyz;
                tmp4.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _RedMiddleColor.xyz;
                tmp4.xyz = _RedMiddleColor.www * tmp4.xyz + tmp2.xyz;
                tmp3.xyz = tmp3.xyz - tmp4.xyz;
                tmp3.xyz = tmp0.xxx * tmp3.xyz + tmp4.xyz;
                tmp5.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _RedBottomColor.xyz;
                tmp5.xyz = _RedBottomColor.www * tmp5.xyz + tmp2.xyz;
                ...
                tmp5.xy = _ColorMaskUV1.xx * tmp5.xy + inp.texcoord.xy;
                tmp5 = tex2D(_ColorMask, tmp5.xy);
                tmp3.xyz = tmp5.xxx * tmp3.xyz + tmp4.xyz;
                tmp1.xyz = tmp1.xyz - tmp3.xyz;
                tmp1.xyz = tmp5.yyy * tmp1.xyz + tmp3.xyz;
                tmp3.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _BlueTopColor.xyz;
                tmp3.xyz = _BlueTopColor.www * tmp3.xyz + tmp2.xyz;
                tmp4.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _BlueMiddleColor.xyz;
                tmp4.xyz = _BlueMiddleColor.www * tmp4.xyz + tmp2.xyz;
                tmp3.xyz = tmp3.xyz - tmp4.xyz;
                tmp3.xyz = tmp0.xxx * tmp3.xyz + tmp4.xyz;
                tmp6.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _BlueBottomColor.xyz;
                tmp6.xyz = _BlueBottomColor.www * tmp6.xyz + tmp2.xyz;
                tmp4.xyz = tmp4.xyz - tmp6.xyz;
                tmp4.xyz = tmp0.xxx * tmp4.xyz + tmp6.xyz;
                tmp3.xyz = tmp3.xyz - tmp4.xyz;
                tmp0.xyz = tmp0.yyy * tmp3.xyz + tmp4.xyz;
                tmp0.xyz = tmp0.xyz - tmp1.xyz;
                tmp0.xyz = tmp5.zzz * tmp0.xyz + tmp1.xyz;
                tmp1.x = tmp5.x * _GlossPowerRGB.x;
                tmp1.y = -tmp5.x * _GlossPowerRGB.x + _GlossPowerRGB.y;
                tmp1.x = tmp5.y * tmp1.y + tmp1.x;
                tmp1.y = _GlossPowerRGB.z - tmp1.x;
                tmp1.x = tmp5.z * tmp1.y + tmp1.x;
                tmp1.x = tmp1.x * 16.0 + -1.0;
                tmp1.x = exp(tmp1.x);
                tmp0.w = tmp0.w * tmp1.x;
                tmp0.w = exp(tmp0.w);
                tmp1.x = tmp0.w * tmp0.w;
                tmp1.y = tmp5.x * _GlossRGB.x;
                tmp1.z = -tmp5.x * _GlossRGB.x + _GlossRGB.y;
                tmp1.y = tmp5.y * tmp1.z + tmp1.y;
                tmp1.z = _GlossRGB.z - tmp1.y;
                tmp1.y = tmp5.z * tmp1.z + tmp1.y;
                tmp1.x = tmp1.y * tmp1.x;
                tmp0.w = tmp0.w * tmp1.x;
                tmp1.x = tmp5.y + tmp5.x;
                tmp1.x = saturate(tmp5.z + tmp1.x);
                tmp1.x = 1.0 - tmp1.x;
