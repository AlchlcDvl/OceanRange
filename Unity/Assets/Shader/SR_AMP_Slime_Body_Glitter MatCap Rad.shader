	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp3.xyz = unity_MatrixV._m02_m12_m22 * tmp2.zzz + tmp3.xyz;
                tmp1.w = tmp3.z * 1.0;
                tmp4.xyz = tmp1.yyy * unity_MatrixV._m01_m11_m21;
                tmp4.xyz = unity_MatrixV._m00_m10_m20 * tmp1.xxx + tmp4.xyz;
                tmp4.xyz = unity_MatrixV._m02_m12_m22 * tmp1.zzz + tmp4.xyz;
                tmp5.z = tmp1.w * tmp4.z;
                tmp5.xy = tmp3.xy * float2(-1.0, -1.0) + tmp4.xy;
                ...
                tmp4.xyz = -tmp4.xyz * tmp0.www + float3(1.0, 1.0, 1.0);
                ...
                tmp4 = tex2D(_CubemapOverride, tmp0.zw);
                tmp0.z = tmp4.w * _OverrideBlend;
                tmp3.xyz = tmp3.xyz * tmp0.zzz;
                tmp3.xyz = -_UseOverride.xxx * tmp3.xyz + float3(1.0, 1.0, 1.0);
                ...
                tmp4.xyz = tmp4.xyz - tmp6.xyz;
                tmp0.xzw = tmp0.xxx * tmp4.xyz + tmp6.xyz;
                tmp4.xyz = tmp0.yyy * float3(0.625, 0.625, 0.625) + tmp0.xzw;
                tmp4.xyz = -tmp5.xyz * tmp0.xzw + tmp4.xyz;
                tmp0.xyz = tmp0.xzw * tmp5.xyz;
                tmp0.xyz = tmp4.xyz * float3(0.8, 0.8, 0.8) + tmp0.xyz;
                tmp0.xyz = float3(1.0, 1.0, 1.0) - tmp0.xyz;
                tmp0.xyz = saturate(-tmp0.xyz * tmp3.xyz + float3(1.0, 1.0, 1.0));
                ...
                tmp3.xy = tmp1.xy * float2(0.25, 0.25);
                ...
                tmp1.xyz = tmp0.www * tmp1.xyz;
                o.sv_target.xyz = tmp0.xyz * float3(1.5, 1.5, 1.5) + tmp1.xyz;
                o.sv_target.w = 1.0;
                return o;
			}
			ENDCG
