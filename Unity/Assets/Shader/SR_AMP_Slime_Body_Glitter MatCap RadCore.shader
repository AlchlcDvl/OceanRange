Shader "SR/AMP/Slime/Body/Glitter MatCap RadCore" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp4 = inp.texcoord.xyxy * _Noise_ST + _Noise_ST;
                tmp4 = _Time * float4(0.1, -0.25, -0.1, -0.1) + tmp4;
                tmp5 = tex2D(_Noise, tmp4.zw);
                ...
                tmp5.xyz = -tmp5.xyz * tmp1.www + float3(1.0, 1.0, 1.0);
                tmp6.xyz = tmp0.zzz * tmp4.xyz;
                ...
                tmp0.z = tmp5.w * _OverrideBlend;
                tmp4.xyz = tmp4.xyz * tmp0.zzz;
                tmp4.xyz = -_UseOverride.xxx * tmp4.xyz + float3(1.0, 1.0, 1.0);
                ...
                tmp5.xyz = _TopColor.www * tmp5.xyz + tmp6.xyz;
                tmp7.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _MiddleColor.xyz;
                tmp7.xyz = _MiddleColor.www * tmp7.xyz + tmp6.xyz;
                ...
                tmp8.xyz = _BottomColor.www * tmp8.xyz + tmp6.xyz;
                ...
                tmp5.xyz = tmp5.xyz - tmp7.xyz;
                tmp5.xyz = tmp0.xxx * tmp5.xyz + tmp7.xyz;
                tmp0.xyz = tmp0.yyy * float3(0.625, 0.625, 0.625) + tmp5.xyz;
                tmp0.xyz = -tmp6.xyz * tmp5.xyz + tmp0.xyz;
                tmp5.xyz = tmp5.xyz * tmp6.xyz;
                tmp0.xyz = tmp0.xyz * float3(0.8, 0.8, 0.8) + tmp5.xyz;
                tmp0.xyz = float3(1.0, 1.0, 1.0) - tmp0.xyz;
                tmp0.xyz = saturate(-tmp0.xyz * tmp4.xyz + float3(1.0, 1.0, 1.0));
                ...
                tmp3.xy = tmp1.zw * float2(0.25, 0.25);
