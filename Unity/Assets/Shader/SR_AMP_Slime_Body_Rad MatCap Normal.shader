Shader "SR/AMP/Slime/Body/Rad MatCap Normal" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp2.z = tmp2.z * 1.0;
                tmp3.xyz = tmp1.zzz * unity_MatrixV._m01_m11_m21;
                tmp3.xyz = unity_MatrixV._m00_m10_m20 * tmp1.yyy + tmp3.xyz;
                tmp1.yzw = unity_MatrixV._m02_m12_m22 * tmp1.www + tmp3.xyz;
                tmp3.z = tmp1.w * tmp2.z;
                tmp3.xy = tmp2.xy * float2(-1.0, -1.0) + tmp1.yz;
                ...
                tmp1.yzw = tmp2.xyz - float3(0.5, 0.5, 0.5);
                tmp1.yzw = -tmp1.yzw * float3(2.0, 2.0, 2.0) + float3(1.0, 1.0, 1.0);
                tmp1.xyz = -tmp1.yzw * tmp1.xxx + float3(1.0, 1.0, 1.0);
