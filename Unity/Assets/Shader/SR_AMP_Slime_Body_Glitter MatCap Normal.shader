Shader "SR/AMP/Slime/Body/Glitter MatCap Normal" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.x = 1.0 - tmp0.z;
                tmp2.xyz = tmp1.zzz * unity_MatrixV._m01_m11_m21;
                tmp2.xyz = unity_MatrixV._m00_m10_m20 * tmp1.yyy + tmp2.xyz;
                tmp1.yzw = unity_MatrixV._m02_m12_m22 * tmp1.www + tmp2.xyz;
                ...
                tmp2.xyz = tmp0.xxx * tmp2.xyz + tmp5.xyz;
                ...
                tmp2.xyz = tmp2.xyz - tmp5.xyz;
                tmp0.xzw = tmp0.zzz * tmp2.xyz + tmp5.xyz;
