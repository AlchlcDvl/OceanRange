Shader "SR/AMP/Slime/Body/Galaxy BoomCracks" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.z = tmp1.x * 0.625 + tmp0.z;
                tmp0.z = saturate(tmp0.z + 0.15);
                tmp1.y = dot(tmp3.xyz, tmp2.xyz);
                tmp2 = texCUBE(_Stars, tmp2.xyz);
                tmp1.z = saturate(tmp2.x * 5.0);
                tmp0.y = saturate(dot(tmp1.xy, tmp0.xy));
                tmp1.y = 1.0 - tmp1.y;
                tmp0.z = tmp0.z - tmp1.y;
                tmp0.z = _BodyLightingContribution * tmp0.z + tmp1.y;
                ...
                tmp1.yzw = tmp0.xxx * tmp1.yzw + tmp3.xyz;
                ...
                tmp3.xyz = tmp1.xxx * float3(0.625, 0.625, 0.625) + tmp1.yzw;
                tmp3.xyz = -tmp2.xyz * tmp1.yzw + tmp3.xyz;
                tmp1.xyz = tmp1.yzw * tmp2.xyz;
                ...
                tmp0.xz = inp.texcoord.xy * _CrackNoise_ST.xy + _CrackNoise_ST.zw;
                tmp1.w = _CrackNoiseSpeed * _Time.y;
                tmp0.xz = tmp1.ww * float2(0.06, -3.0) + tmp0.xz;
                tmp4 = tex2D(_CrackNoise, tmp0.xz);
                tmp0.x = tmp4.x * 2.0 + -1.0;
                tmp0.x = tmp0.x * _CrackAmount;
                tmp3.xyz = tmp0.xxx * float3(0.03, 0.03, 0.03) + tmp3.xyz;
                tmp3 = texCUBE(_Cracks, tmp3.xyz);
                tmp0.x = tmp3.x * -0.25 + 1.0;
                ...
                tmp0.x = tmp0.z * tmp0.x;
                tmp1.yzw = tmp0.xxx * tmp1.yzw + float3(1.0, 1.0, 1.0);
                tmp0.x = tmp0.y * 40.0;
                tmp0.yz = tmp0.yy * float2(10.0, 10.0) + float2(-0.8, -0.333);
                tmp0.yz = saturate(tmp0.yz * float2(5.0, 2.994012));
                tmp0.x = saturate(tmp0.x);
                tmp2.x = tmp0.x * -2.0 + 3.0;
                tmp0.x = tmp0.x * tmp0.x;
                tmp0.x = tmp0.x * tmp2.x;
                tmp0.x = tmp0.x * -0.05 + 1.0;
                ...
                tmp0.z = tmp0.w * _CrackAmount;
                tmp3.yzw = tmp0.zzz * tmp3.yzw + tmp5.xyz;
                ...
                o.sv_target.xyz = tmp0.xxx * tmp1.yzw + tmp0.yzw;
                o.sv_target.w = 1.0;
                return o;
			}
			ENDCG
