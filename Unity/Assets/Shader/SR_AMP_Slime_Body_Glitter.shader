Shader "SR/AMP/Slime/Body/Glitter" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.xyz = _TopColor.www * tmp1.xyz + tmp4.xyz;
                ...
                tmp1.xyz = tmp1.xyz - tmp5.xyz;
                tmp0.xzw = tmp0.zzz * tmp1.xyz + tmp5.xyz;
                tmp1.xyz = tmp0.yyy * float3(0.625, 0.625, 0.625) + tmp0.xzw;
                tmp1.xyz = -tmp4.xyz * tmp0.xzw + tmp1.xyz;
                tmp0.xyz = tmp0.xzw * tmp4.xyz;
