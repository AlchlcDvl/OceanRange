Shader "SR/AMP/Slime/Body/MatCap BoomCracks" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.xyw = _UseOverride.xxx * tmp1.xyz + tmp0.xyw;
                ...
                tmp2.xyw = _Char.xxx * tmp1.yzx + tmp0.ywx;
                ...
                tmp2.xy = tmp1.yz * float2(-2.0, -2.0) + float2(3.0, 3.0);
                ...
                tmp1.yzw = tmp6.xyz * tmp1.yyy + tmp3.yzw;
