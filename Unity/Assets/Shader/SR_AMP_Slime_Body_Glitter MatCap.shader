Shader "SR/AMP/Slime/Body/Glitter MatCap" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp5.xyz = tmp0.zzz * tmp1.xyz;
                tmp1.xyz = tmp1.xyz > float3(0.5, 0.5, 0.5);
                tmp5.xyz = tmp5.xyz + tmp5.xyz;
                tmp1.xyz = saturate(tmp1.xyz ? tmp4.xyz : tmp5.xyz);
                ...
                tmp0.xyz = saturate(-tmp0.xyz * tmp1.xyz + float3(1.0, 1.0, 1.0));
