Shader "SR/AMP/Slime/Body/Matcap MultiColor" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _GreenTopColor.xyz;
                tmp4.xyz = glstate_lightmodel_ambient.xyz + glstate_lightmodel_ambient.xyz;
                tmp1.xyz = _GreenTopColor.www * tmp1.xyz + tmp4.xyz;
                tmp5.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _GreenMiddleColor.xyz;
                tmp5.xyz = _GreenMiddleColor.www * tmp5.xyz + tmp4.xyz;
                tmp1.xyz = tmp1.xyz - tmp5.xyz;
                tmp1.xyz = tmp0.xxx * tmp1.xyz + tmp5.xyz;
                tmp6.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _GreenBottomColor.xyz;
                tmp6.xyz = _GreenBottomColor.www * tmp6.xyz + tmp4.xyz;
                tmp5.xyz = tmp5.xyz - tmp6.xyz;
                tmp5.xyz = tmp0.xxx * tmp5.xyz + tmp6.xyz;
                tmp1.xyz = tmp1.xyz - tmp5.xyz;
                tmp1.xyz = tmp0.www * tmp1.xyz + tmp5.xyz;
                tmp5.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _RedTopColor.xyz;
                tmp5.xyz = _RedTopColor.www * tmp5.xyz + tmp4.xyz;
                tmp6.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _RedMiddleColor.xyz;
                tmp6.xyz = _RedMiddleColor.www * tmp6.xyz + tmp4.xyz;
                tmp5.xyz = tmp5.xyz - tmp6.xyz;
                tmp5.xyz = tmp0.xxx * tmp5.xyz + tmp6.xyz;
                tmp7.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _RedBottomColor.xyz;
                tmp7.xyz = _RedBottomColor.www * tmp7.xyz + tmp4.xyz;
                tmp6.xyz = tmp6.xyz - tmp7.xyz;
                tmp6.xyz = tmp0.xxx * tmp6.xyz + tmp7.xyz;
                tmp5.xyz = tmp5.xyz - tmp6.xyz;
                tmp5.xyz = tmp0.www * tmp5.xyz + tmp6.xyz;
                tmp6.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _TopColor.xyz;
                tmp6.xyz = _TopColor.www * tmp6.xyz + tmp4.xyz;
                tmp7.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _MiddleColor.xyz;
                tmp7.xyz = _MiddleColor.www * tmp7.xyz + tmp4.xyz;
                tmp6.xyz = tmp6.xyz - tmp7.xyz;
                tmp6.xyz = tmp0.xxx * tmp6.xyz + tmp7.xyz;
                tmp8.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _BottomColor.xyz;
                tmp8.xyz = _BottomColor.www * tmp8.xyz + tmp4.xyz;
                tmp7.xyz = tmp7.xyz - tmp8.xyz;
                tmp7.xyz = tmp0.xxx * tmp7.xyz + tmp8.xyz;
                tmp6.xyz = tmp6.xyz - tmp7.xyz;
                tmp6.xyz = tmp0.www * tmp6.xyz + tmp7.xyz;
                tmp5.xyz = tmp5.xyz - tmp6.xyz;
                tmp7.xy = inp.texcoord.zw - inp.texcoord.xy;
                tmp7.zw = _ColorMaskUV1.xx * tmp7.xy + inp.texcoord.xy;
                tmp7.xy = _OverrideAlphaUV1.xx * tmp7.xy + inp.texcoord.xy;
                tmp8 = tex2D(_CubemapOverride, tmp7.xy);
                tmp1.w = tmp8.w * _OverrideBlend;
                tmp7 = tex2D(_ColorMask, tmp7.zw);
                tmp5.xyz = tmp7.xxx * tmp5.xyz + tmp6.xyz;
                tmp1.xyz = tmp1.xyz - tmp5.xyz;
                tmp1.xyz = tmp7.yyy * tmp1.xyz + tmp5.xyz;
                tmp5.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _BlueTopColor.xyz;
                tmp5.xyz = _BlueTopColor.www * tmp5.xyz + tmp4.xyz;
                tmp6.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _BlueMiddleColor.xyz;
                tmp6.xyz = _BlueMiddleColor.www * tmp6.xyz + tmp4.xyz;
                tmp5.xyz = tmp5.xyz - tmp6.xyz;
                tmp5.xyz = tmp0.xxx * tmp5.xyz + tmp6.xyz;
                tmp8.xyz = -glstate_lightmodel_ambient.xyz * float3(2.0, 2.0, 2.0) + _BlueBottomColor.xyz;
                tmp8.xyz = _BlueBottomColor.www * tmp8.xyz + tmp4.xyz;
                tmp6.xyz = tmp6.xyz - tmp8.xyz;
                tmp6.xyz = tmp0.xxx * tmp6.xyz + tmp8.xyz;
                tmp0.x = tmp0.x * 0.25 + 0.25;
                tmp5.xyz = tmp5.xyz - tmp6.xyz;
                tmp5.xyz = tmp0.www * tmp5.xyz + tmp6.xyz;
                tmp5.xyz = tmp5.xyz - tmp1.xyz;
                tmp1.xyz = tmp7.zzz * tmp5.xyz + tmp1.xyz;
                tmp0.w = tmp7.x * _GlossPowerRGB.x;
                tmp2.w = -tmp7.x * _GlossPowerRGB.x + _GlossPowerRGB.y;
                tmp0.w = tmp7.y * tmp2.w + tmp0.w;
                tmp2.w = _GlossPowerRGB.z - tmp0.w;
                tmp0.w = tmp7.z * tmp2.w + tmp0.w;
                tmp0.w = tmp0.w * 16.0 + -1.0;
                tmp0.w = exp(tmp0.w);
                tmp0.y = tmp0.y * tmp0.w;
                tmp0.y = exp(tmp0.y);
                tmp0.w = tmp0.y * tmp0.y;
                tmp2.w = tmp7.x * _GlossRGB.x;
                tmp3.w = -tmp7.x * _GlossRGB.x + _GlossRGB.y;
                tmp2.w = tmp7.y * tmp3.w + tmp2.w;
                tmp3.w = _GlossRGB.z - tmp2.w;
                tmp2.w = tmp7.z * tmp3.w + tmp2.w;
                tmp0.w = tmp0.w * tmp2.w;
                tmp0.y = tmp0.y * tmp0.w;
                tmp0.w = tmp7.y + tmp7.x;
                tmp0.w = saturate(tmp7.z + tmp0.w);
                tmp0.w = 1.0 - tmp0.w;
                tmp0.y = tmp0.w * tmp0.z + tmp0.y;
                tmp0.yzw = tmp1.xyz + tmp0.yyy;
                tmp0.yzw = -tmp4.xyz * tmp1.xyz + tmp0.yzw;
                ...
                tmp2.z = tmp2.z * 1.0;
                tmp3.xy = tmp2.xy * float2(-1.0, -1.0) + tmp1.xy;
                ...
                o.sv_target.xyz = _UseOverride.xxx * tmp1.xyz + tmp0.yzw;
                o.sv_target.w = 1.0;
                return o;
			}
			ENDCG
