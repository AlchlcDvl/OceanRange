Shader "SR/AMP/Slime/Body/MultiColor Normal" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.xy = _ColorMaskUV1.xx * tmp1.xy + inp.texcoord.xy;
                tmp2 = tex2D(_ColorMask, tmp1.xy);
                ...
                tmp0.yzw = _WorldSpaceCameraPos - tmp4.xyz;
                tmp1.w = dot(tmp0.xyz, tmp0.xyz);
                tmp1.w = max(tmp1.w, 0.001);
                tmp1.w = rsqrt(tmp1.w);
                tmp4.xyz = tmp0.yzw * tmp1.www;
                ...
                tmp0.x = _BodyLightingContribution * tmp0.x + tmp2.w;
                ...
                tmp1.xyz = _GreenTopColor.www * tmp1.xyz + tmp3.xyz;
                ...
                tmp4.xyz = tmp4.xyz - tmp5.xyz;
                tmp4.xyz = tmp0.www * tmp4.xyz + tmp5.xyz;
                tmp4.xyz = tmp4.xyz - tmp1.xyz;
                tmp1.xyz = tmp2.zzz * tmp4.xyz + tmp1.xyz;
                tmp0.x = tmp2.x * _GlossPowerRGB.x;
                tmp0.w = -tmp2.x * _GlossPowerRGB.x + _GlossPowerRGB.y;
                tmp0.x = tmp2.y * tmp0.w + tmp0.x;
                tmp0.w = _GlossPowerRGB.z - tmp0.x;
                tmp0.x = tmp2.z * tmp0.w + tmp0.x;
                tmp0.x = tmp0.x * 16.0 + -1.0;
                tmp0.x = exp(tmp0.x);
                tmp0.x = tmp0.y * tmp0.x;
                tmp0.x = exp(tmp0.x);
                tmp0.y = tmp0.x * tmp0.x;
                tmp0.w = tmp2.x * _GlossRGB.x;
                tmp1.w = -tmp2.x * _GlossRGB.x + _GlossRGB.y;
                tmp0.w = tmp2.y * tmp1.w + tmp0.w;
                tmp1.w = _GlossRGB.z - tmp0.w;
                tmp0.w = tmp2.z * tmp1.w + tmp0.w;
                tmp0.y = tmp0.w * tmp0.y;
                tmp0.x = tmp0.x * tmp0.y;
                tmp0.y = tmp2.y + tmp2.x;
                tmp0.y = saturate(tmp2.z + tmp0.y);
                tmp0.y = 1.0 - tmp0.y;
