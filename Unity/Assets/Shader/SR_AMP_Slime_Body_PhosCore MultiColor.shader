Shader "SR/AMP/Slime/Body/PhosCore MultiColor" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.z = saturate(tmp0.w * 2.0 + -1.0);
                ...
                tmp4.xyz = tmp4.xyz - tmp5.xyz;
                tmp4.xyz = tmp1.zzz * tmp4.xyz + tmp5.xyz;
                ...
                tmp5.xyz = tmp5.xyz - tmp6.xyz;
                tmp5.xyz = tmp1.zzz * tmp5.xyz + tmp6.xyz;
                tmp4.xyz = tmp4.xyz - tmp5.xyz;
                ...
                tmp1.z = -tmp6.x * _GlossPowerRGB.x + _GlossPowerRGB.y;
                tmp0.w = tmp6.y * tmp1.z + tmp0.w;
                tmp1.z = _GlossPowerRGB.z - tmp0.w;
                tmp0.w = tmp6.z * tmp1.z + tmp0.w;
                tmp0.w = tmp0.w * 16.0 + -1.0;
                tmp0.w = exp(tmp0.w);
                tmp0.y = tmp0.y * tmp0.w;
                tmp0.y = exp(tmp0.y);
                tmp0.w = tmp0.y * tmp0.y;
                tmp1.z = tmp6.x * _GlossRGB.x;
                tmp1.w = -tmp6.x * _GlossRGB.x + _GlossRGB.y;
                tmp1.z = tmp6.y * tmp1.w + tmp1.z;
                tmp1.w = _GlossRGB.z - tmp1.z;
                tmp1.z = tmp6.z * tmp1.w + tmp1.z;
