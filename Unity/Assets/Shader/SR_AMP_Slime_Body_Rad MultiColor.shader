Shader "SR/AMP/Slime/Body/Rad MultiColor" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.x = tmp5.x * _GlossPowerRGB.x;
                tmp0.w = -tmp5.x * _GlossPowerRGB.x + _GlossPowerRGB.y;
                tmp0.x = tmp5.y * tmp0.w + tmp0.x;
                tmp0.w = _GlossPowerRGB.z - tmp0.x;
                tmp0.x = tmp5.z * tmp0.w + tmp0.x;
                tmp0.x = tmp0.x * 16.0 + -1.0;
                tmp0.x = exp(tmp0.x);
                tmp0.x = tmp0.y * tmp0.x;
                tmp0.x = exp(tmp0.x);
                tmp0.y = tmp0.x * tmp0.x;
                tmp0.w = tmp5.x * _GlossRGB.x;
                tmp1.w = -tmp5.x * _GlossRGB.x + _GlossRGB.y;
                tmp0.w = tmp5.y * tmp1.w + tmp0.w;
                tmp1.w = _GlossRGB.z - tmp0.w;
                tmp0.w = tmp5.z * tmp1.w + tmp0.w;
                tmp0.y = tmp0.w * tmp0.y;
                tmp0.x = tmp0.x * tmp0.y;
                tmp0.y = tmp5.y + tmp5.x;
                tmp0.y = saturate(tmp5.z + tmp0.y);
                tmp0.y = 1.0 - tmp0.y;
                tmp0.x = tmp0.y * tmp0.z + tmp0.x;
                tmp0.xyz = tmp1.xyz + tmp0.xxx;
                tmp0.xyz = -tmp2.xyz * tmp1.xyz + tmp0.xyz;
                tmp1.xyz = tmp1.xyz * tmp2.xyz;
                tmp0.xyz = tmp0.xyz * float3(0.8, 0.8, 0.8) + tmp1.xyz;
