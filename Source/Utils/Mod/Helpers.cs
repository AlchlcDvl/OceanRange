...
public static partial class Helpers
{
    ...
    public static Dictionary<string, TValue> ReadDictionary<TValue>(this BinaryReader reader, Func<BinaryReader, TValue> valueRead) => reader.ReadDictionary(ReadString, valueRead);

    public static T ReadEnum<T>(this BinaryReader reader) where T : struct, Enum => ParseEnum<T>(reader.ReadString2());
    ...
    // public static object ReadEnum(this BinaryReader reader) => Enum.Parse(reader.ReadType(), reader.ReadString2());

    public static T ReadModData<T>(this BinaryReader reader) where T : Data.ModData, new() => (T) new T().Deserialise(reader);

    public static string ReadString(this BinaryReader reader) => reader.ReadString();

    public static string ReadString2(this BinaryReader reader) => reader.ReadBoolean() ? null : reader.ReadString();
