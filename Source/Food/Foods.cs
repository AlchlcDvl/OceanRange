...
public static class Foods
{
    ...
    {
        BaseCreateChimken("Sandy", Ids.SANDY_CHICKEN, "#C2B280", Ids.SANDY_CHICKEN_ENTRY, json["SANDY_HEN"], Ids.SANDY_CHICK, "#C2B280", Ids.SANDY_CHICK_ENTRY, json["SANDY_CHICK"], []);
    }
    ...
    )
    {
        ...
        VacItemCreation.NewVacItem(0, chickPrefab, chickId, $"{name} Chick", chickIcon, chickAmmoColor.HexToColor());
        ...
        VacItemCreation.NewVacItem(0, henPrefab, henId, $"{name} Hen", henIcon, henAmmoColor.HexToColor());
