...
public static class Translator
{
    ...
    public static string GetText(this Dictionary<string, string> dict, string lang) => dict.TryGetValue(lang, out var text) ? text : dict[LangHolder.Fallback]; // English is guaranteed to exist here
