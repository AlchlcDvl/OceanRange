...
/// </summary>
[Manager(ManagerType.FloppyDisk)]
public static class FloppyDisk
{
    ...
    private static readonly ISaveData[] SaveData = [new MailSaveDataV01(), new GordoSaveDataV01(), new GordoSaveDataV02(), new MailSaveDataV02()];
