...
public static class LargoManager
{
    ...
    */
    ...
    {
        //COCO LARGOS
        CreateLargo(Ids.PINK_COCO_LARGO, Ids.COCO_SLIME, IdentifiableId.PINK_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2);
        CreateLargo(Ids.COCO_SABER_LARGO, IdentifiableId.SABER_SLIME, Ids.COCO_SLIME, SlimeRegistry.LargoProps.REPLACE_BASE_MAT_AS_SLIME2);
        ...
        CreateLargo(Ids.COCO_HONEY_LARGO, Ids.COCO_SLIME, IdentifiableId.HONEY_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2);
        CreateLargo(Ids.COCO_PHOSPHOR_LARGO, Ids.COCO_SLIME, IdentifiableId.PHOSPHOR_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2);
        CreateLargo(Ids.COCO_MOSAIC_LARGO, Ids.COCO_SLIME, IdentifiableId.MOSAIC_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2);
        CreateLargo(Ids.COCO_TANGLE_LARGO, Ids.COCO_SLIME, IdentifiableId.TANGLE_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2);
        CreateLargo(Ids.COCO_BOOM_LARGO, Ids.COCO_SLIME, IdentifiableId.BOOM_SLIME, SlimeRegistry.LargoProps.REPLACE_BASE_MAT_AS_SLIME2);
        CreateLargo(Ids.COCO_RAD_LARGO, Ids.COCO_SLIME, IdentifiableId.RAD_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2);
        CreateLargo(Ids.COCO_ROCK_LARGO, Ids.COCO_SLIME, IdentifiableId.ROCK_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2);
        CreateLargo(Ids.COCO_TABBY_LARGO, Ids.COCO_SLIME, IdentifiableId.TABBY_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2);
        CreateLargo(Ids.COCO_HUNTER_LARGO, Ids.COCO_SLIME, IdentifiableId.HUNTER_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2);
        CreateLargo(Ids.COCO_CRYSTAL_LARGO, Ids.COCO_SLIME, IdentifiableId.CRYSTAL_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2);
        CreateLargo(Ids.COCO_DERVISH_LARGO, Ids.COCO_SLIME, IdentifiableId.DERVISH_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2);
        CreateLargo(Ids.COCO_MESMER_LARGO, Ids.COCO_SLIME, Ids.MESMER_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2);
        //CreateLargo(Ids.COCO_HERMIT_LARGO, Ids.COCO_SLIME, Ids.HERMIT_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2);

        //MESMER LARGOS
        CreateLargo(Ids.PINK_MESMER_LARGO, Ids.MESMER_SLIME, IdentifiableId.PINK_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2 | SlimeRegistry.LargoProps.RECOLOR_SLIME1_ADDON_MATS);
        CreateLargo(Ids.SABER_MESMER_LARGO, IdentifiableId.SABER_SLIME, Ids.MESMER_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2);
        CreateLargo(Ids.QUANTUM_MESMER_LARGO, IdentifiableId.QUANTUM_SLIME, Ids.MESMER_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2 | SlimeRegistry.LargoProps.REPLACE_SLIME2_ADDON_MATS | SlimeRegistry.LargoProps.RECOLOR_SLIME2_ADDON_MATS);
        CreateLargo(Ids.HONEY_MESMER_LARGO, IdentifiableId.HONEY_SLIME, Ids.MESMER_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2 | SlimeRegistry.LargoProps.REPLACE_SLIME2_ADDON_MATS | SlimeRegistry.LargoProps.RECOLOR_SLIME2_ADDON_MATS);
        CreateLargo(Ids.PHOSPHOR_MESMER_LARGO, IdentifiableId.PHOSPHOR_SLIME, Ids.MESMER_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2 | SlimeRegistry.LargoProps.RECOLOR_SLIME1_ADDON_MATS);
        CreateLargo(Ids.MOSAIC_MESMER_LARGO, Ids.MESMER_SLIME, IdentifiableId.MOSAIC_SLIME, SlimeRegistry.LargoProps.NONE);
        CreateLargo(Ids.TANGLE_MESMER_LARGO, Ids.MESMER_SLIME, IdentifiableId.TANGLE_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2 | SlimeRegistry.LargoProps.RECOLOR_SLIME1_ADDON_MATS);
        CreateLargo(Ids.BOOM_MESMER_LARGO, IdentifiableId.BOOM_SLIME, Ids.MESMER_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2 | SlimeRegistry.LargoProps.REPLACE_SLIME2_ADDON_MATS | SlimeRegistry.LargoProps.RECOLOR_SLIME2_ADDON_MATS);
        CreateLargo(Ids.RAD_MESMER_LARGO, IdentifiableId.RAD_SLIME, Ids.MESMER_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2 | SlimeRegistry.LargoProps.REPLACE_SLIME2_ADDON_MATS | SlimeRegistry.LargoProps.RECOLOR_SLIME2_ADDON_MATS);
        CreateLargo(Ids.ROCK_MESMER_LARGO, Ids.MESMER_SLIME, IdentifiableId.ROCK_SLIME, SlimeRegistry.LargoProps.RECOLOR_SLIME2_ADDON_MATS);
        CreateLargo(Ids.TABBY_MESMER_LARGO, Ids.MESMER_SLIME, IdentifiableId.TABBY_SLIME, SlimeRegistry.LargoProps.RECOLOR_SLIME2_ADDON_MATS);
        CreateLargo(Ids.HUNTER_MESMER_LARGO, IdentifiableId.HUNTER_SLIME, Ids.MESMER_SLIME, SlimeRegistry.LargoProps.RECOLOR_BASE_MAT_AS_SLIME2 | SlimeRegistry.LargoProps.RECOLOR_SLIME1_ADDON_MATS | SlimeRegistry.LargoProps.SWAP_MOUTH | SlimeRegistry.LargoProps.SWAP_EYES);
        CreateLargo(Ids.CRYSTAL_MESMER_LARGO, Ids.MESMER_SLIME, IdentifiableId.CRYSTAL_SLIME, SlimeRegistry.LargoProps.RECOLOR_SLIME2_ADDON_MATS);
        CreateLargo(Ids.DERVISH_MESMER_LARGO, Ids.MESMER_SLIME, IdentifiableId.DERVISH_SLIME, SlimeRegistry.LargoProps.RECOLOR_SLIME2_ADDON_MATS);
        // CreateLargo(Ids.MESMER_HERMIT_LARGO, Ids.MESMER_SLIME, Ids.HERMIT_SLIME, SlimeRegistry.LargoProps.RECOLOR_SLIME2_ADDON_MATS);
