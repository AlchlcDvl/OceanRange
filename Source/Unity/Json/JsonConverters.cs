...
/// <summary>
/// Generic converter for lists of SerializableKeyValuePair to map-like JSON objects.
/// </summary>
/// <typeparam name="TKey">Key type (currently string is supported).</typeparam>
/// <typeparam name="TValue">Value type.</typeparam>
/// <typeparam name="TPair">Concrete pair type.</typeparam>
public abstract class KeyValueListJsonConverter<TKey, TValue, TPair> : OceanJsonConverter<List<TPair>>
    where TPair : SerializableKeyValuePair<TKey, TValue>, new()
{
    ...
    {
        // Currently we only support string keys for json object properties
        if (typeof(TKey) != typeof(string))
            throw new JsonSerializationException($"Unsupported key type {typeof(TKey).Name}. Only string keys are supported.");
...
[Serializable]
public sealed class StringStringPairListConverter : KeyValueListJsonConverter<string, string, SerializableStringStringPair>;

[Serializable]
public sealed class StringStringArrayPairListConverter : KeyValueListJsonConverter<string, string[], SerializableStringStringArrayPair>;

[Serializable]
public sealed class StringColorPairListConverter : KeyValueListJsonConverter<string, Color, SerializableStringColorPair>;

[Serializable]
public sealed class StringVector3ArrayPairListConverter : KeyValueListJsonConverter<string, Vector3[], SerializableStringVector3ArrayPair>;

[Serializable]
public sealed class StringZoneRequirementPairListConverter : KeyValueListJsonConverter<string, ZoneRequirementData, SerializableStringZoneRequirementDataPair>;

// Nested list converters
[Serializable]
public sealed class StringToStringPairListConverter : KeyValueListJsonConverter<string, List<SerializableStringStringPair>, SerializableStringStringPairListPair>;

[Serializable]
public sealed class StringToStringPairListPairListConverter : KeyValueListJsonConverter<string, List<SerializableStringStringPairListPair>, SerializableStringStringPairListPairListPair>;

[Serializable]
public sealed class StringToStringVector3ArrayPairListConverter : KeyValueListJsonConverter<string, List<SerializableStringVector3ArrayPair>, SerializableStringStringVector3ArrayPairListPair>;
