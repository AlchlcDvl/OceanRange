...
// /// Color converter.
// /// </summary>
// public sealed class ColorConverter() : BaseColorConverter<Color, float>(NumberStyles.HexNumber, float.TryParse, 1f, Helpers.TryHexToColor)
// {
//     /// <inheritdoc/>
...
/// Color32 converter.
/// </summary>
public sealed class Color32Converter() : BaseColorConverter<Color32, byte>(NumberStyles.HexNumber, byte.TryParse, 255, UnityUtils.TryParseColor32)
{
    /// <inheritdoc/>
